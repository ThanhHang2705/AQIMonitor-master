...
public class GetDataForMap extends AsyncTask<String, String,String> {
    LatLng latLng;
    double radius;
    String JsonResult=null;
    Context context;
    KQNode kqNode;
    public GetDataForMap (Context context, LatLng latLng, double radius){
...
//            kqNode = new KQNode(ID,name_node,address,pm25,temperature,humidity,new LatLng(latitude,longtitude));
            saveData();
            this.cancel(true);
