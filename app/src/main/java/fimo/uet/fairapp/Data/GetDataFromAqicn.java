...
public class GetDataFromAqicn extends AsyncTask<String, String,String>{
    String ID;
    String JsonResult=null;
    Context context;
    KQNode kqNode;
    public GetDataFromAqicn (Context context, String id){
        this.ID = id;
    ...
    public void parseJsonResult(String JsonResult){
        try {
            ...
            double pm25 = iaqi.getJSONObject("pm25").getInt("v");
            double temperature = (int)Math.round(iaqi.getJSONObject("t").getDouble("v"));
            double humidity = iaqi.getJSONObject("h").getInt("v");
